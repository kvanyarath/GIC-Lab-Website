    ...
    public function boot()
    {
        ...
        $menus = [
            ...
            ["label" => "project", "submenu" => [
                ["label" => "Completed Project", "url_name"=> 'frontend.project', 'url' => '/gic-projects/completed'],
                ["label" => 'Proccessing Project', "url_name"=> 'frontend.project', 'url' => '/gic-projects/processing'],
            ]],
