        ...
        <div class="row align-items-center no-gutters">
            <div class="col-md-6 order-md-2">
                <div class="text-center g-pa-15x">
                    ...
                    <a  class="btn u-btn-outline-primary g-font-weight-600 g-rounded-50 g-px-30 g-py-13" id="project{{$projects[0]->id}}">@lang('Quick View')
                        <i class="ml-2 fa fa-eye"></i></a>
                </div>
            </div>
        ...
        <div class="row align-items-center no-gutters">
            <div class="col-md-6">
                <div class="text-center g-pa-15x">
                    ...
                    <a target="_blank"  class="btn u-btn-outline-primary g-font-weight-600 g-rounded-50 g-px-30 g-py-13" id="project{{$projects[1]->id}}">@lang('Quick View')
                        <i class="ml-2 fa fa-eye"></i></a>
                </div>
            </div>
