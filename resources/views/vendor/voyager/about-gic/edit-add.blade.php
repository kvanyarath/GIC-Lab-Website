        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs nav-justified">
                    ...
                    <li id="t4" class="nav-item">
                        <a class="nav-link" href="#">Vissions</a>
                    </li>
                </ul>
...
@section('javascript')
    ...
    <script>
        $(function() {
            let taps = {
                't1': [
                    'Location', 'Facebook', 'Youtube', 'Twitter', 
                    'Instagram', 'Linkedin', 'Email', 'Phone'
                ],
                't2': ['About Us Text En', 'About Us Text Kh'],
                't3': ['Mission En', 'Mission Kh'],
                't4': ['Vision En', 'Vision Kh'],
            };
