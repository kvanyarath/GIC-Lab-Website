<li class="hs-has-sub-menu nav-item g-mx-10--lg g-mx-15--xl" data-animation-in="fadeIn" data-animation-out="fadeOut">
    <a id="nav-link-pages" class="nav-link g-py-7 g-px-0" href="#" aria-haspopup="true" aria-expanded="false" aria-controls="nav-submenu-pages">About GIC</a>
    ...
    <li class="dropdown-item hs-has-sub-menu ">
        ...
        <!-- Submenu (level 2) -->
        <ul class="hs-sub-menu list-unstyled u-shadow-v11 u-dropdown-col-2 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2" id="nav-submenu--pages--portfolio" aria-labelledby="nav-link--pages--portfolio" style="display: none;">
        <li class="dropdown-item ">
    ...
    <li class="dropdown-item hs-has-sub-menu ">
        ...
        <!-- Submenu (level 2) -->
        <ul class="hs-sub-menu list-unstyled u-shadow-v11 u-dropdown-col-2 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2" id="nav-submenu--pages--login-signup" aria-labelledby="nav-link--pages--login-signup" style="display: none;">
        <li class="dropdown-item ">
    ...
    <li class="dropdown-item hs-has-sub-menu ">
        ...
        <!-- Submenu (level 2) -->
        <ul class="hs-sub-menu list-unstyled u-shadow-v11 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2" id="nav-submenu--pages--services" aria-labelledby="nav-link--pages--services" style="display: none;">
        <li class="dropdown-item ">
    ...
    <li class="dropdown-item hs-has-sub-menu ">
        ...
        <!-- Submenu (level 2) -->
        <ul class="hs-sub-menu list-unstyled u-shadow-v11 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2" id="nav-submenu--pages--search-result" aria-labelledby="nav-link--pages--search-result" style="display: none;">
        <li class="dropdown-item ">
    ...
    <li class="dropdown-item hs-has-sub-menu ">
        ...
        <!-- Submenu (level 2) -->
        <ul class="hs-sub-menu list-unstyled u-shadow-v11 u-dropdown-col-2 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2" id="nav-submenu--pages--profile" aria-labelledby="nav-link--pages--profile" style="display: none;">
        <li class="dropdown-item ">
    ...
    <li class="dropdown-item hs-has-sub-menu ">
        ...
        <!-- Submenu (level 2) -->
        <ul class="hs-sub-menu list-unstyled u-shadow-v11 u-dropdown-col-2 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2" id="nav-submenu--pages--contacts" aria-labelledby="nav-link--pages--contacts" style="display: none;">
        <li class="dropdown-item ">
    ...
    <li class="dropdown-item hs-has-sub-menu ">
        ...
        <!-- Submenu (level 2) -->
        <ul class="hs-sub-menu list-unstyled u-shadow-v11 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2" id="nav-submenu--pages--jobs" aria-labelledby="nav-link--pages--jobs" style="display: none;">
        <li class="dropdown-item ">
    ...
    <li class="dropdown-item hs-has-sub-menu ">
        ...
        <!-- Submenu (level 2) -->
        <ul class="hs-sub-menu list-unstyled u-shadow-v11 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2" id="nav-submenu--pages--faq" aria-labelledby="nav-link--pages--faq" style="display: none;">
        <li class="dropdown-item ">
    ...
    <li class="dropdown-item hs-has-sub-menu ">
        ...
        <ul class="hs-sub-menu list-unstyled u-shadow-v11 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2" id="nav-submenu--pages--others" aria-labelledby="nav-link--pages--others" style="display: none;">
        <!-- Clients -->
        <li class="dropdown-item ">
        ...
        <li class="dropdown-item hs-has-sub-menu ">
            ...
            <ul class="hs-sub-menu list-unstyled u-shadow-v11 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2" id="nav-submenu--pages--404" aria-labelledby="nav-link--pages--404" style="display: none;">
            <li class="dropdown-item ">
        ...
        <li class="dropdown-item hs-has-sub-menu ">
            ...
            <ul class="hs-sub-menu list-unstyled u-shadow-v11 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2" id="nav-submenu--pages--coming-soon" aria-labelledby="nav-link--pages--coming-soon" style="display: none;">
            <li class="dropdown-item ">
